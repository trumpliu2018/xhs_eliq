  ...
  component: [
    {
      ...
      list: [
        {
          subName: '发小红书按钮',
          subNameTra: 'post-note-button',
          id: 'post-note-button',
          containComponents: [
            {
              tagName: 'post-note-button',
            }
          ],
        },
        {
          subName: '群聊组件',
          subNameTra: 'group-chat-card',
          id: 'group-chat-card',
          containComponents: [
            {
              tagName: 'group-chat-card',
            }
          ],
        }
      ],
...

    {
      ...
      list: [
        ...
        {
          subName: '视频高级用法',
          subNameTra: 'video-autoplay',
          id: 'video-autoplay',
          containComponents: [
            {
              tagName: 'video-autoplay',
              props: {
                src: 'https://sf1-cdn-tos.huoshanstatic.com/obj/media-fe/xgplayer_doc_video/mp4/xgplayer-demo-360p.mp4'
              }
            }
        ...
        {
          subName: '短剧播放器(专为短剧业务服务)',
          subNameTra: 'video-player',
          id: 'video-player'
        },
      ]
    },
...

    {
      ...
      list: [
        ...
        {
          subName: '基础分享(站/内外/复制链接)',
          id: 'share-sample'
        },
        {
          subName: '基础按钮分享(站/内外)',
          id: 'share-sample-button'
        },
        {
          subName: '带快照的分享(站外分享截屏控制)',
          id: 'share-snapshoot'
        },
        {
          subName: '直播预约',
        ...
        {
          subName: '带shareTicket的分享(站/内外/复制链接)',
          id: 'share-ticket'
        },
        {
          subName: '获取服务组件token查询',
          id: 'service-widght'
        },
        {
          subName: '获取分享者回调(shareTicket)',
          id: 'share-shareTicket'
        },
        {
          subName: '错误监听',
          id: 'error-catch'
      ...
      list: [
        {
          ...
          containApis: [
            ...
            'onScreenRecorderStateChange',
            'offScreenRecorderStateChange',
          ],
        },
        {
          subName: '屏幕亮度',
