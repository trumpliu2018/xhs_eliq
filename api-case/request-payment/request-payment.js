...
const SIT_SECRET = 'c6409ad5e089e2ceba58571cb745a058';
const BETA_SECRET = '24906284213ef241efa0b1f57abe56ca';
// const PROD_SECRET = '24906284213ef241efa0b1f57abe56ca'
const PROD_SECRET = '18c4677d24791d7496639882999cf261';
...
Page({
  ...
  data: {
    customPaytoken: '',
    customOrderId: '',
    customPayMethod: 'test',
    customAppId: '627a424c3d56430001c675fd',
  ...
  handlePayTokenChange(e){
    this.setData({
      customPaytoken: e.detail.value
    });
  },

  handleOrderIdChange(e){
    this.setData({
      customOrderId: e.detail.value
    });
  },

  handlePayMethodChange(e){
    this.setData({
      customPayMethod: e.detail.value
    });
  },

  handleAppIdChange(e){
    this.setData({
      customAppId: e.detail.value
    });
  },

  handleCustomPayment(){
    const orderInfo = {
      payToken: this.data.customPaytoken,
      orderId: this.data.customOrderId,
      payMethod: this.data.customPayMethod,
      appId: this.data.customAppId,
    };
