...
Component({
  ...
  methods: {
    ...
    getNode: function (t) {
      try {
        for (
          var e = t.split("_"), r = this.data.childs[e[0]], i = 1;
          i < e.length;
          i++
        )
          r = r.children[e[i]];
    ...
    play: function (t) {
      ...
      if (
        ...
        for (var o = !1, s = t.target.id, a = this.root._videos.length; a--; )
          this.root._videos[a].id === s
            ? (o = !0)
            : this.root._videos[a].pause();
        if (!o) {
    ...
    imgLoad: function (t) {
      var e,
        ...
        o = this.getNode(i);
      o.w
        ? ((this.data.opts[1] && !this.data.ctrl[i]) ||
            -1 === this.data.ctrl[i]) &&
          (e = 1)
        : (e = t.detail.width),
    ...
    mediaError: function (t) {
      ...
      if ("video" === i.name || "audio" === i.name) {
        ...
        "img" === i.name &&
          (this.data.opts[2] && this.setData(r({}, "ctrl." + e, -1)),
          this.checkReady());
      this.root &&
