...
function n(t, i) {
  for (var e = t.indexOf("&"); -1 !== e; ) {
    ...
    "#" === t[e + 1]
      ...
      isNaN(n) ||
          (t = t.substr(0, e) + String.fromCharCode(n) + t.substr(s + 1)))
      : ((n = t.substring(e + 1, s)),
...
(r.prototype.onTagName = function (t) {
  ...
  "svg" === this.tagName &&
        ((this.xml = (this.xml || 0) + 1), (l.ignoreTags.style = void 0));
}),
...
(r.prototype.onOpenTag = function (t) {
  ...
  if (
    (h[i.name] && (e.class = h[i.name] + (e.class ? " " + e.class : "")),
    "embed" === i.name)
  ) {
    var r = e.src || "";
    r.includes(".mp4") ||
            ...
            if (u.includes("flex") && "100%" === o.width)
              ...
              u.includes("inline-block") &&
                  (o.width && "%" === o.width[o.width.length - 1]
                    ? ((p.attrs.style += ";max-width:" + o.width),
                    (o.width = ""))
...
(r.prototype.popNode = function () {
  ...
  if (
    ...
    if ("a" === i.name || "ad" === i.name) this.expose();
      ...
      (p.height || "").includes("auto") && (p.height = void 0),
      (i.children = void 0);
      ...
      if ("table" === i.name) {
        ...
        if (
          ...
          (i.flag = void 0),
          (p.display = "grid"),
          "collapse" === p["border-collapse"] &&
                ((p["border-collapse"] = void 0), (g = 0)),
          g
              ...
              if ("td" === j.name || "th" === j.name) {
                ...
                if (
                  ...
                  for (var z = 1; z < j.attrs.rowspan; z++)
                    for (var F = 0; F < (j.attrs.colspan || 1); F++)
                      k[N + z + "." + (T - F)] = 1;
                }
      ...
      M[e.type] &&
          ((e.style += ";list-style-type:" + M[e.type]), (e.type = void 0)),
      (i.c = 1);
